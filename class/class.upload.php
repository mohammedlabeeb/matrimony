...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists('class/class.upload.' . $lang . '.php')) {
            $translation = null;
            include('class/class.upload.' . $lang . '.php');
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_resize) {
                        ...
                        if ($gd_version >= 2) {
                        	/*echo "image_dst_x:".$this->image_dst_x.";;;";
                        	echo "image_dst_y:".$this->image_dst_y.";;;";
                        	echo "image_src_x:".$this->image_src_x.";;;";
                        	echo "image_src_y:".$this->image_src_y.";;;";*/
                        	//image_dst_x:21;;;image_dst_y:9;;;image_src_x:400;;;image_src_y:173;;;
                        	/*
                        	 * $image_src         - image source
                        	 * $this->image_src_x - width we want
                        	 * $this->image_src_y - height we want
                        	 */
							if($this->jcrop){
								//echo "JCROP IS TRUE!";
								$res = imagecopyresampled($image_dst, $image_src, 0, 0, $this->posX, $this->posY, $this->image_x, $this->image_y, $this->rect_w, $this->rect_h);
							} 
							else 
