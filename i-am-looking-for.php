...
$sel="select * from register_view where email='$smid' or matri_id='$smid'";
$query=mysql_query($sel)or die(mysql_error());
$row=mysql_fetch_array($query);


$b=$row['part_height'];
$c=$row['part_height_to'];
...
$g=$row['gender'];
	...
	$targetpage = "i-am-looking-for.php"; 	//your file name  (the name of this file)
	...
	$SQL=mysql_query("select * from register_view where country_id='$cou' $asd AND religion='$rel' AND caste='$caste' AND gender!='$g' AND ((
			(
...
<div class="container">	
 ...
 <!-----------------------Menu part end------------------------->
	...
	?>			<div class="col-lg-12 col-xs-12">                		  
                        <img src="images/no_Data.jpg" width="550" height="350" style="margin-left:100px;" />      
                        </div>
     <?php
	}
	else
