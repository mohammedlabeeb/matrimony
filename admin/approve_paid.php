...
setPageContext("member","approve-paid");
...
<div id="wrapper">
  ...
  <div id="container" class="cf">
    ...
    <div class="widecolumn alignleft">
      <div class="breadcum-wide"><a href="#" title="Members">Members</a> / <a href="#" title="Approve Active To Paid Member Details">Approve Active To Paid Member Details</a></div>
    ...
    <p class="submit-btn cf">
		...
		<input type="hidden" name="action"  id="filter_action" value="SEARCH" />
			...
			<?php
					...
					?><span style='float:right'><a href='approve_paid.php?option=clear_search&member_status=Active'> <span title='Clear Filter'
	...
	<?php
	   ...
	   <div class="nodata-avail ">
            <h1>Approve Active To Paid Member Details</h1>
          </div>  	
	...
	<form method="post" action="approve_paid.php" id="action_form">
	 <?php						
	...
	<!-- MEMBERSHIP PLAN-1 START -->
        ...
        <input type="hidden" name="email[]" value="<?php echo $DatabaseCo->dbRow->email; ?>" />
			...
			<label class="detail-desc2 cf"> <label class="title-label">Email:</label>
                ...
                <a href="javascript:;" onclick="approvePaid(<?php echo $DatabaseCo->dbRow->index_id; ?>);">
		<span title="Approve As Paid" class="floor-plan">Approve As Paid</span>
        </a>
...
<?php if($DatabaseCo->dbRow->status=="Active")
  ...
  <?php 
	    ...
	    echo getNewPagination('approve_paid.php','register_page_size','register','index_id',$page_size,$current_page,$SQL_STATEMENT_PAGINATION);
	  ?>	
     </div>
	 <?php
	  }
