...
error_reporting(0);
	...
	$targetpage = "exp_sent_pending.php"; 	//your file name  (the name of this file)
	...
	if($page) 
     ...
     $sql2= "SELECT * FROM expressinterest,register WHERE register.matri_id=expressinterest.ei_receiver and ei_sender='$mid' AND receiver_response='Pending'";
 	...
 	<div class="row">   
            ...
            <div class="col-xs-12 col-sm-9 col-sm-push-3 col-xs-push-0">                
                ...
                <div class="panel-heading">
                  <h3 class="panel-title">Express Interest Send Pending</h3>                
                </div>
