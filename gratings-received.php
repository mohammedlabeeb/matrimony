<?php
	...
	$query = mysql_query("SELECT COUNT(*) as num FROM $tbl_name where receiver='$mid'");
	$total_pages = mysql_fetch_array($query);
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "gratings-received.php"; 	//your file name  (the name of this file)
	...
	$SQL= mysql_query("SELECT * from register_view JOIN gratings ON gratings.sender=register_view.matri_id where  gratings.receiver='$mid' LIMIT $start, $limit");
...
<div class="container">	
	...
	<?php include "page-part/menu.php";?><!-----------------------Menu part end------------------------->
 	...
 	<ol class="breadcrumb">
  		...
  		<li class="active">Greeting Message Received </li>
	</ol>
 	<div class="row">   
		...
		<div class="panel panel-warning"><div class="panel-heading">
     	<i class="glyphicon glyphicon-share"></i>You recently received the Greeting Message from the members listed here.
        </div></div>    
          <div class="panel panel-warning">
                <div class="panel-heading">
                  <h3 class="panel-title">My Greeting Received </h3>                
                </div>
              ...
              <div class="modal-body">
                <div class="col-sm-4 col-xs-12 text-center padding-left-right-zero-small">
                   <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-xs-offset-0 text-center thumbnail margin-bottom-zero ">
                     <b class="text-danger"><?php echo $Row['sender']; ?>-<span><?php echo $Row['username']; ?></span>
                     </b>
                   </div>
                                     <?php
   if($Row['photo1']!="" && $Row['photo_pswd']=="" && $Row['photo1_approve']!="UNAPPROVED")
	...
	<a href="gratingsong/<?php echo $Row['song']; ?>"><?php echo $Row['song']; ?></a>
                    ...
                    <div class="clearfix"></div>
                    <div class="col-xs-12 margin-top-10px padding-left-right-zero-small"><b class="text-primary col-sm-3 col-xs-12">Recived On:</b>
                 ...
                 <a target="_blank" href="memprofile.php?PMid=<?php echo $Row['sender']; ?>">
