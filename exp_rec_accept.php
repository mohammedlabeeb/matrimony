...
error_reporting(0);
	...
	// How many adjacent pages should be shown on each side?
        ...
        $query = "SELECT COUNT(*) as num FROM $tbl_name,register WHERE register.matri_id=expressinterest.ei_sender and ei_receiver='$mid' AND receiver_response='Accept'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "exp_rec_accept.php"; 	//your file name  (the name of this file)
	...
	if($page) 
		...
		$start = 0;	
                ...
                $sql2= "SELECT * FROM expressinterest,register WHERE register.matri_id=expressinterest.ei_sender and ei_receiver='$mid' AND receiver_response='Accept'";
 	...
 	<div class="row">   
            ...
            <div class="col-xs-12 col-sm-9 col-sm-push-3 col-xs-push-0">                
                ...
                <div class="panel-heading">
                  <h3 class="panel-title">Express Interest Received Accepted</h3>                
                </div>
