...
<div class="wrapper gradient">  
	...
	<article style="margin-top:-50px;">
          ...
          <div class="panel panel-success">
            ...
            <p><i class="glyphicon glyphicon-arrow-right"></i> Search based on a Keyword criteria one would look for in a partner. If you like a profile you can Express Interest or Send Mail. </p>
            <p class="clearfix"></p>
...
<option value="60">60</option>
		   ...
		   <div class="form-row">
  				...
  				<div class="form-row">
			<div class="form-label"><label>Keyword</label></div>
													<div class="form-fields">
		...
		<input type="text" name="keyword" id="keyword"  class="form-control">
			...
			<br clear="all" />
    			...
    			<div class="col-sm-offset-2 col-sm-10 col-xs-12 col-xs-offset-0">
      			<button type="submit" name="keyword_search" class="btn btn-success col-sm-3 col-xs-12"> Search </button>
    			</div>
  				</div>
				</form>
          ...
          <div class="col-sm-3 col-sm-pull-9 col-xs-12 col-xs-pull-0">     
           <?php require_once 'page-part/featured-video.php';   
				include 'advertise/add_single.php';    ?>
        </div>
      </div>	
