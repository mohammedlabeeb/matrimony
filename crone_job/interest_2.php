...
$sql="SELECT * FROM expressinterest WHERE ei_sent_date  > DATE_SUB(NOW(), INTERVAL 2 HOUR) AND ei_sent_date  <= NOW() and Year(ei_sent_date)='$year' and Month(ei_sent_date)='$month' AND receiver_response='Pending'";
...
$subject = "New Express Interest Received";	
$message = '<table>
<tbody>
<tr>
<td>
