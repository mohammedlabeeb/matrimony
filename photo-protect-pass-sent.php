                ...
                <div class="col-xs-12 col-sm-9 col-xs-push-0 col-sm-push-3">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                          <h3 class="panel-title">My Accepted Photo Password Request </h3>                
                        </div>
                        <div class="panel-body">
                            <?php
                           $SQL_STATEMENT =  "SELECT * FROM photoprotect_request WHERE ph_receiver_id='$mid' and 	receiver_response='Accepted' ORDER BY ph_reqdate DESC";
							...
							if($num=mysql_num_rows($DatabaseCo->dbResult)>0)
							{
								...
								<div class="border_dotted messge" id="load">
									<div class="text-primary title_msg">
									  ...
									  <b>&nbsp;&nbsp;&nbsp; You have sent your photo password to <?php echo $DatabaseCo->dbRow->ph_requester_id; ?>.
									  </b></a>
