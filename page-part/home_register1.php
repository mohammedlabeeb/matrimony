...
function GetCastemobile(strURL) 
{
		var req4 = getXMLHTTP();		
		if (req4) 
		{
			req4.onreadystatechange = function() 
			{
					if (req4.readyState == 4) 
					{
						if(req4.status == 200) 
						{						
						document.getElementById('CasteDivmobile').innerHTML=req4.responseText;						
						} 
						else 
						{
 ...
 <form name="regform" id="regform" class="form-horizontal" action="register.php" method="post"  onSubmit="return regvalid();">
    ...
    <div class="col-sm-8">
        <select name="religion_id" class="form-control" id="religion_id" onchange="GetCastemobile('ajax_search2.php?religionId='+this.value)" data-validation-engine="validate[required]">
    ...
    <div class="col-sm-8" id="CasteDivmobile">
